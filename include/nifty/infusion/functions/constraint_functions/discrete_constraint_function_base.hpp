...
#include "nifty/infusion/functions/value_functions/constraint_function_base.hpp"
...
class DiscreteConstraintFunctionBase : public ConstraintFunctionBase<DERIVED>{
public:
    ...
    bool operator()(const DiscreteLabelType l0)const{
        return this->derived_cast().operator()(&l0);
    }

    bool operator()(const DiscreteLabelType l0, const DiscreteLabelType l1)const{
        const DiscreteLabelType l[2] = {l0, l1};
        return this->derived_cast().operator()(l);
    }

    bool operator()(const DiscreteLabelType l0, const DiscreteLabelType l1, 
