...
:   public DiscreteFunctionBase<PottsFunction<0>>
{
    typedef DiscreteFunctionBase<PottsFunction<0>> BaseType;
...
class PottsFunction
:   public DiscreteFunctionBase<PottsFunction<N_LABELS>>
{
    typedef DiscreteFunctionBase<PottsFunction<N_LABELS>> BaseType;
